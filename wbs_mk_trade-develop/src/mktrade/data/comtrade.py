...
def download_task_b(cfg: DataConfig) -> list[Path]:
    ...
    """
    # The focus reporter supplies actual MKD routes; destination reporters
    # supply product-level import demand and competitor information.
    reporters = list(
        dict.fromkeys(cfg.comtrade_reporters_m49 + cfg.comtrade_market_reporters_m49)
    )
